...
<div class="jumbotron jumbotron-fluid text-white bg-dark text-center">
  <div class="container">
    <h1 class="display-4">PICATCLAS Hardware Store</h1>
  </div>
</div>
 ...
 <!-- <a href="../view/view.login.php">You're already registered. Log in</a> -->
 <a href="../view/view.register.php">You haven't registered. Register Now</a>
